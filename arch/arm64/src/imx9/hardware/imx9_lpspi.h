...
#define IMX9_LPSPI_VERID_OFFSET       0x0000  /* Version ID Register offset */
#define IMX9_LPSPI_PARAM_OFFSET       0x0004  /* Parameter Register offset */
#define IMX9_LPSPI_CR_OFFSET          0x0010  /* Control Register offset */
#define IMX9_LPSPI_SR_OFFSET          0x0014  /* Status Register offset */
#define IMX9_LPSPI_IER_OFFSET         0x0018  /* Interrupt Enable Register offset */
#define IMX9_LPSPI_DER_OFFSET         0x001C  /* DMA Enable Register offset */
#define IMX9_LPSPI_CFGR0_OFFSET       0x0020  /* Configuration Register 0 offset */
#define IMX9_LPSPI_CFGR1_OFFSET       0x0024  /* Configuration Register 1 offset */
#define IMX9_LPSPI_DMR0_OFFSET        0x0030  /* Data Match Register 0 offset */
#define IMX9_LPSPI_DMR1_OFFSET        0x0034  /* Data Match Register 1 offset */
#define IMX9_LPSPI_CCR_OFFSET         0x0040  /* Clock Configuration Register offset */
#define IMX9_LPSPI_FCR_OFFSET         0x0058  /* FIFO Control Register offset */
#define IMX9_LPSPI_FSR_OFFSET         0x005C  /* FIFO Status Register offset */
#define IMX9_LPSPI_TCR_OFFSET         0x0060  /* Transmit Command Register offset */
#define IMX9_LPSPI_TDR_OFFSET         0x0064  /* Transmit Data Register offset */
#define IMX9_LPSPI_RSR_OFFSET         0x0070  /* Receive Status Register offset */
#define IMX9_LPSPI_RDR_OFFSET         0x0074  /* Receive Data Register offset */

/* Register addresses *******************************************************/

#define IMX9_LPSPI1_VERID             (IMX9_LPSPI1_BASE + IMX9_LPSPI_VERID_OFFSET)
#define IMX9_LPSPI1_PARAM             (IMX9_LPSPI1_BASE + IMX9_LPSPI_PARAM_OFFSET)
#define IMX9_LPSPI1_CR                (IMX9_LPSPI1_BASE + IMX9_LPSPI_CR_OFFSET)
#define IMX9_LPSPI1_SR                (IMX9_LPSPI1_BASE + IMX9_LPSPI_SR_OFFSET)
#define IMX9_LPSPI1_IER               (IMX9_LPSPI1_BASE + IMX9_LPSPI_IER_OFFSET)
#define IMX9_LPSPI1_DER               (IMX9_LPSPI1_BASE + IMX9_LPSPI_DER_OFFSET)
#define IMX9_LPSPI1_CFGR0             (IMX9_LPSPI1_BASE + IMX9_LPSPI_CFGR0_OFFSET)
#define IMX9_LPSPI1_CFGR1             (IMX9_LPSPI1_BASE + IMX9_LPSPI_CFGR1_OFFSET)
#define IMX9_LPSPI1_DMR0              (IMX9_LPSPI1_BASE + IMX9_LPSPI_DMR0_OFFSET)
#define IMX9_LPSPI1_DMR1              (IMX9_LPSPI1_BASE + IMX9_LPSPI_DMR1_OFFSET)
#define IMX9_LPSPI1_CCR               (IMX9_LPSPI1_BASE + IMX9_LPSPI_CCR_OFFSET)
#define IMX9_LPSPI1_FCR               (IMX9_LPSPI1_BASE + IMX9_LPSPI_FCR_OFFSET)
#define IMX9_LPSPI1_FSR               (IMX9_LPSPI1_BASE + IMX9_LPSPI_FSR_OFFSET)
#define IMX9_LPSPI1_TCR               (IMX9_LPSPI1_BASE + IMX9_LPSPI_TCR_OFFSET)
#define IMX9_LPSPI1_TDR               (IMX9_LPSPI1_BASE + IMX9_LPSPI_TDR_OFFSET)
#define IMX9_LPSPI1_RSR               (IMX9_LPSPI1_BASE + IMX9_LPSPI_RSR_OFFSET)
#define IMX9_LPSPI1_RDR               (IMX9_LPSPI1_BASE + IMX9_LPSPI_RDR_OFFSET)

#define IMX9_LPSPI2_VERID             (IMX9_LPSPI2_BASE + IMX9_LPSPI_VERID_OFFSET)
#define IMX9_LPSPI2_PARAM             (IMX9_LPSPI2_BASE + IMX9_LPSPI_PARAM_OFFSET)
#define IMX9_LPSPI2_CR                (IMX9_LPSPI2_BASE + IMX9_LPSPI_CR_OFFSET)
#define IMX9_LPSPI2_SR                (IMX9_LPSPI2_BASE + IMX9_LPSPI_SR_OFFSET)
#define IMX9_LPSPI2_IER               (IMX9_LPSPI2_BASE + IMX9_LPSPI_IER_OFFSET)
#define IMX9_LPSPI2_DER               (IMX9_LPSPI2_BASE + IMX9_LPSPI_DER_OFFSET)
#define IMX9_LPSPI2_CFGR0             (IMX9_LPSPI2_BASE + IMX9_LPSPI_CFGR0_OFFSET)
#define IMX9_LPSPI2_CFGR1             (IMX9_LPSPI2_BASE + IMX9_LPSPI_CFGR1_OFFSET)
#define IMX9_LPSPI2_DMR0              (IMX9_LPSPI2_BASE + IMX9_LPSPI_DMR0_OFFSET)
#define IMX9_LPSPI2_DMR1              (IMX9_LPSPI2_BASE + IMX9_LPSPI_DMR1_OFFSET)
#define IMX9_LPSPI2_CCR               (IMX9_LPSPI2_BASE + IMX9_LPSPI_CCR_OFFSET)
#define IMX9_LPSPI2_FCR               (IMX9_LPSPI2_BASE + IMX9_LPSPI_FCR_OFFSET)
#define IMX9_LPSPI2_FSR               (IMX9_LPSPI2_BASE + IMX9_LPSPI_FSR_OFFSET)
#define IMX9_LPSPI2_TCR               (IMX9_LPSPI2_BASE + IMX9_LPSPI_TCR_OFFSET)
#define IMX9_LPSPI2_TDR               (IMX9_LPSPI2_BASE + IMX9_LPSPI_TDR_OFFSET)
#define IMX9_LPSPI2_RSR               (IMX9_LPSPI2_BASE + IMX9_LPSPI_RSR_OFFSET)
#define IMX9_LPSPI2_RDR               (IMX9_LPSPI2_BASE + IMX9_LPSPI_RDR_OFFSET)

#define IMX9_LPSPI3_VERID             (IMX9_LPSPI3_BASE + IMX9_LPSPI_VERID_OFFSET)
#define IMX9_LPSPI3_PARAM             (IMX9_LPSPI3_BASE + IMX9_LPSPI_PARAM_OFFSET)
#define IMX9_LPSPI3_CR                (IMX9_LPSPI3_BASE + IMX9_LPSPI_CR_OFFSET)
#define IMX9_LPSPI3_SR                (IMX9_LPSPI3_BASE + IMX9_LPSPI_SR_OFFSET)
#define IMX9_LPSPI3_IER               (IMX9_LPSPI3_BASE + IMX9_LPSPI_IER_OFFSET)
#define IMX9_LPSPI3_DER               (IMX9_LPSPI3_BASE + IMX9_LPSPI_DER_OFFSET)
#define IMX9_LPSPI3_CFGR0             (IMX9_LPSPI3_BASE + IMX9_LPSPI_CFGR0_OFFSET)
#define IMX9_LPSPI3_CFGR1             (IMX9_LPSPI3_BASE + IMX9_LPSPI_CFGR1_OFFSET)
#define IMX9_LPSPI3_DMR0              (IMX9_LPSPI3_BASE + IMX9_LPSPI_DMR0_OFFSET)
#define IMX9_LPSPI3_DMR1              (IMX9_LPSPI3_BASE + IMX9_LPSPI_DMR1_OFFSET)
#define IMX9_LPSPI3_CCR               (IMX9_LPSPI3_BASE + IMX9_LPSPI_CCR_OFFSET)
#define IMX9_LPSPI3_FCR               (IMX9_LPSPI3_BASE + IMX9_LPSPI_FCR_OFFSET)
#define IMX9_LPSPI3_FSR               (IMX9_LPSPI3_BASE + IMX9_LPSPI_FSR_OFFSET)
#define IMX9_LPSPI3_TCR               (IMX9_LPSPI3_BASE + IMX9_LPSPI_TCR_OFFSET)
#define IMX9_LPSPI3_TDR               (IMX9_LPSPI3_BASE + IMX9_LPSPI_TDR_OFFSET)
#define IMX9_LPSPI3_RSR               (IMX9_LPSPI3_BASE + IMX9_LPSPI_RSR_OFFSET)
#define IMX9_LPSPI3_RDR               (IMX9_LPSPI3_BASE + IMX9_LPSPI_RDR_OFFSET)

#define IMX9_LPSPI4_VERID             (IMX9_LPSPI4_BASE + IMX9_LPSPI_VERID_OFFSET)
#define IMX9_LPSPI4_PARAM             (IMX9_LPSPI4_BASE + IMX9_LPSPI_PARAM_OFFSET)
#define IMX9_LPSPI4_CR                (IMX9_LPSPI4_BASE + IMX9_LPSPI_CR_OFFSET)
#define IMX9_LPSPI4_SR                (IMX9_LPSPI4_BASE + IMX9_LPSPI_SR_OFFSET)
#define IMX9_LPSPI4_IER               (IMX9_LPSPI4_BASE + IMX9_LPSPI_IER_OFFSET)
#define IMX9_LPSPI4_DER               (IMX9_LPSPI4_BASE + IMX9_LPSPI_DER_OFFSET)
#define IMX9_LPSPI4_CFGR0             (IMX9_LPSPI4_BASE + IMX9_LPSPI_CFGR0_OFFSET)
#define IMX9_LPSPI4_CFGR1             (IMX9_LPSPI4_BASE + IMX9_LPSPI_CFGR1_OFFSET)
#define IMX9_LPSPI4_DMR0              (IMX9_LPSPI4_BASE + IMX9_LPSPI_DMR0_OFFSET)
#define IMX9_LPSPI4_DMR1              (IMX9_LPSPI4_BASE + IMX9_LPSPI_DMR1_OFFSET)
#define IMX9_LPSPI4_CCR               (IMX9_LPSPI4_BASE + IMX9_LPSPI_CCR_OFFSET)
#define IMX9_LPSPI4_FCR               (IMX9_LPSPI4_BASE + IMX9_LPSPI_FCR_OFFSET)
#define IMX9_LPSPI4_FSR               (IMX9_LPSPI4_BASE + IMX9_LPSPI_FSR_OFFSET)
#define IMX9_LPSPI4_TCR               (IMX9_LPSPI4_BASE + IMX9_LPSPI_TCR_OFFSET)
#define IMX9_LPSPI4_TDR               (IMX9_LPSPI4_BASE + IMX9_LPSPI_TDR_OFFSET)
#define IMX9_LPSPI4_RSR               (IMX9_LPSPI4_BASE + IMX9_LPSPI_RSR_OFFSET)
#define IMX9_LPSPI4_RDR               (IMX9_LPSPI4_BASE + IMX9_LPSPI_RDR_OFFSET)
