...
#define SHIFT_TO_CH0_N_EYE_VALUE      26 /* 26-28 */
#define SHIFT_TO_CH1_N_EYE_VALUE      29 /* 29-31 */
                                           ...
                                           uint8_t p_early_threshold)
{
  ...
  putreg32(((LIBERO_SETTING_CH1_CNTL & REG_RX0_EYEWIDTH_P_MASK) |
 ...
 *
 * Assumptions:
 *   This should be run outside of eNVM
 *
 ****************************************************************************/
...
__attribute__((section(".ram"))) void mpfs_mux_post_mss_pll_config(void)
{
  ...
  /* Make sure we change clock in eNVM first so ready by the time we
   * leave
   */
...
static void mpfs_sgmii_setup(void)
{
  ...
  putreg32((1 << 10) | (0x7f), MPFS_CFG_DDR_SGMII_PHY_DYN_CNTL);
  ...
  modifyreg32(MPFS_IOSCB_CALIB_SGMII_IOC_REG0, 0, (1 << 14));
  ...
  while (!((getreg32(MPFS_CFG_DDR_SGMII_PHY_PLL_CNTL) & (1 << 7))));
  ...
  putreg32((1 << 14) | (1 << 13) | (0x7f), MPFS_CFG_DDR_SGMII_PHY_DYN_CNTL);
  putreg32((0 << 14) | (0 << 13) | (0x7f), MPFS_CFG_DDR_SGMII_PHY_DYN_CNTL);
  ...
  if (silicon_variant == PART_REVC_OR_LATER)
    {
      ...
      if ((getreg32(MPFS_CFG_DDR_SGMII_PHY_SPARE_STAT) & ARO_REF_PCODE_MASK)
          <= ARO_REF_PCODE_REVC_THRESHOLD)
        {
          ...
          putreg32((1 << 14) | (1 << 13) | (0x7f << 0),
                   MPFS_CFG_DDR_SGMII_PHY_DYN_CNTL);
          putreg32((0 << 14) | (0 << 13) | (0x7f << 0),
                   MPFS_CFG_DDR_SGMII_PHY_DYN_CNTL);
        }
    }
...
void mpfs_clockconfig(void)
{
  ...
  putreg32((0x01 << 10) | (0x7f), MPFS_CFG_DDR_SGMII_PHY_DYN_CNTL);

  /* DCE:111, CORE_UP:1, FLASH_VALID:0, mss_io_en:0 */

  putreg32((0x00 << 13) | (0x00 << 12) | (0x01 << 11) | (0x07 << 8),
  ...
  putreg32((0x00 << 13) | (0x00 << 12) | (0x01 << 11) | (0x00 << 8),
           MPFS_SYSREGSCB_MSSIO_CONTROL_CR);
  ...
  putreg32((0x00 << 13) | (0x01 << 12) | (0x01 << 11) | (0x00 << 8),
           MPFS_SYSREGSCB_MSSIO_CONTROL_CR);
  ...
  putreg32((0x01 << 13) | (0x01 << 12) | (0x01 << 11) | (0x00 << 8),
           MPFS_SYSREGSCB_MSSIO_CONTROL_CR);
