...
CFG_DDR_SGMII_PHY_TypeDef       * CFG_DDR_SGMII_PHY   =  ((CFG_DDR_SGMII_PHY_TypeDef *) CFG_DDR_SGMII_PHY_BASE);
DDR_CSR_APB_TypeDef *DDRCFG =\
        ((DDR_CSR_APB_TypeDef *)       DDRCFG_BASE);


uint32_t ddr_setup(void);
...
void mpfs_clockconfig(void)
{
  ...
  if (hart_id == CONFIG_MPFS_BOOT_HART)
    {
      /* Enable clocks */
