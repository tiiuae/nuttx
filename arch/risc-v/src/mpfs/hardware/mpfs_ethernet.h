...
#define DMA_CONFIG_DMA_ADDR_BUS_WIDTH_1             (1 << 30)
#define DMA_CONFIG_TX_BD_EXTENDED_MODE_EN           (1 << 29)
#define DMA_CONFIG_RX_BD_EXTENDED_MODE_EN           (1 << 28)
#define DMA_CONFIG_FORCE_MAX_AMBA_BURST_TX          (1 << 26)
#define DMA_CONFIG_FORCE_MAX_AMBA_BURST_RX          (1 << 25)
#define DMA_CONFIG_FORCE_DISCARD_ON_ERR             (1 << 24)
#define DMA_CONFIG_RX_BUF_SIZE_SHIFT                (16)
#define DMA_CONFIG_RX_BUF_SIZE_MASK                 (0xff)
#define DMA_CONFIG_CRC_ERROR_REPORT                 (1 << 13)
#define DMA_CONFIG_INFINITE_LAST_DBUF_SIZE_EN       (1 << 12)
#define DMA_CONFIG_TX_PBUF_TCP_EN                   (1 << 11)
#define DMA_CONFIG_TX_PBUF_SIZE                     (1 << 10)
#define DMA_CONFIG_RX_PBUF_SIZE_SHIFT               (8)
#define DMA_CONFIG_RX_PBUF_SIZE_MASK                (3)
#define DMA_CONFIG_ENDIAN_SWAP_PACKET               (1 << 7)
#define DMA_CONFIG_ENDIAN_SWAP_MANAGEMENT           (1 << 6)
#define DMA_CONFIG_HDR_DATA_SPLITTING_EN            (1 << 5)
#define DMA_CONFIG_AMBA_BURST_LENGTH_SHIFT          (0)  /* Bits: 0-4 */
#define DMA_CONFIG_AMBA_BURST_LENGTH_MASK           (1f)
