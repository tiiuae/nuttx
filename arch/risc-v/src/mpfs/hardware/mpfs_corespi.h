...
#ifndef __ARCH_RISC_V_SRC_MPFS_HARDWARE_MPFS_CORESPI_H_
#define __ARCH_RISC_V_SRC_MPFS_HARDWARE_MPFS_CORESPI_H_
...
#endif /* __ARCH_RISC_V_SRC_MPFS_HARDWARE_MPFS_CORESPI_H_ */
