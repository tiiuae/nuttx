...
#define SAM_GMAC_PCS_CONTROL_OFFSET 0x0200 /*  */
...
#define SAM_GMAC_NSR               (MPFS_GMAC_BASE+SAM_GMAC_NSR_OFFSET)
#define SAM_GMAC_UR                (MPFS_GMAC_BASE+SAM_GMAC_UR_OFFSET)
#define SAM_GMAC_DCFGR             (MPFS_GMAC_BASE+SAM_GMAC_DCFGR_OFFSET)
#define SAM_GMAC_TSR               (MPFS_GMAC_BASE+SAM_GMAC_TSR_OFFSET)
#define SAM_GMAC_RBQB              (MPFS_GMAC_BASE+SAM_GMAC_RBQB_OFFSET)
#define SAM_GMAC_TBQB              (MPFS_GMAC_BASE+SAM_GMAC_TBQB_OFFSET)
#define SAM_GMAC_RSR               (MPFS_GMAC_BASE+SAM_GMAC_RSR_OFFSET)
#define SAM_GMAC_ISR               (MPFS_GMAC_BASE+SAM_GMAC_ISR_OFFSET)
#define SAM_GMAC_IER               (MPFS_GMAC_BASE+SAM_GMAC_IER_OFFSET)
#define SAM_GMAC_IDR               (MPFS_GMAC_BASE+SAM_GMAC_IDR_OFFSET)
#define SAM_GMAC_IMR               (MPFS_GMAC_BASE+SAM_GMAC_IMR_OFFSET)
#define SAM_GMAC_MAN               (MPFS_GMAC_BASE+SAM_GMAC_MAN_OFFSET)
#define SAM_GMAC_RPQ               (MPFS_GMAC_BASE+SAM_GMAC_RPQ_OFFSET)
#define SAM_GMAC_TPQ               (MPFS_GMAC_BASE+SAM_GMAC_TPQ_OFFSET)
#define SAM_GMAC_TPSF              (MPFS_GMAC_BASE+SAM_GMAC_TPSF_OFFSET)
#define SAM_GMAC_RPSF              (MPFS_GMAC_BASE+SAM_GMAC_RPSF_OFFSET)
#define SAM_GMAC_HRB               (MPFS_GMAC_BASE+SAM_GMAC_HRB_OFFSET)
#define SAM_GMAC_HRT               (MPFS_GMAC_BASE+SAM_GMAC_HRT_OFFSET)
#define SAM_GMAC_SAB(n)            (MPFS_GMAC_BASE+SAM_GMAC_SAB_OFFSET(n))
#define SAM_GMAC_SAT(n)            (MPFS_GMAC_BASE+SAM_GMAC_SAT_OFFSET(n))
#define SAM_GMAC_SAB1              (MPFS_GMAC_BASE+SAM_GMAC_SAB1_OFFSET)
#define SAM_GMAC_SAT1              (MPFS_GMAC_BASE+SAM_GMAC_SAT1_OFFSET)
#define SAM_GMAC_SAB2              (MPFS_GMAC_BASE+SAM_GMAC_SAB2_OFFSET)
#define SAM_GMAC_SAT2              (MPFS_GMAC_BASE+SAM_GMAC_SAT2_OFFSET)
#define SAM_GMAC_SAB3              (MPFS_GMAC_BASE+SAM_GMAC_SAB3_OFFSET)
#define SAM_GMAC_SAT3              (MPFS_GMAC_BASE+SAM_GMAC_SAT3_OFFSET)
#define SAM_GMAC_SAB4              (MPFS_GMAC_BASE+SAM_GMAC_SAB4_OFFSET)
#define SAM_GMAC_SAT4              (MPFS_GMAC_BASE+SAM_GMAC_SAT4_OFFSET)
#define SAM_GMAC_TIDM(n)           (MPFS_GMAC_BASE+SAM_GMAC_TIDM_OFFSET(n))
#define SAM_GMAC_TIDM1             (MPFS_GMAC_BASE+SAM_GMAC_TIDM1_OFFSET)
#define SAM_GMAC_TIDM2             (MPFS_GMAC_BASE+SAM_GMAC_TIDM2_OFFSET)
#define SAM_GMAC_TIDM3             (MPFS_GMAC_BASE+SAM_GMAC_TIDM3_OFFSET)
#define SAM_GMAC_TIDM4             (MPFS_GMAC_BASE+SAM_GMAC_TIDM4_OFFSET)
#define SAM_GMAC_WOL               (MPFS_GMAC_BASE+SAM_GMAC_WOL_OFFSET)
#define SAM_GMAC_IPGS              (MPFS_GMAC_BASE+SAM_GMAC_IPGS_OFFSET)
#define SAM_GMAC_SVLAN             (MPFS_GMAC_BASE+SAM_GMAC_SVLAN_OFFSET)
#define SAM_GMAC_TPFCP             (MPFS_GMAC_BASE+SAM_GMAC_TPFCP_OFFSET)
#define SAM_GMAC_SAMB1             (MPFS_GMAC_BASE+SAM_GMAC_SAMB1_OFFSET)
#define SAM_GMAC_SAMT1             (MPFS_GMAC_BASE+SAM_GMAC_SAMT1_OFFSET)
#define SAM_GMAC_OTLO              (MPFS_GMAC_BASE+SAM_GMAC_OTLO_OFFSET)
#define SAM_GMAC_OTHI              (MPFS_GMAC_BASE+SAM_GMAC_OTHI_OFFSET)
#define SAM_GMAC_FT                (MPFS_GMAC_BASE+SAM_GMAC_FT_OFFSET)
#define SAM_GMAC_BCFT              (MPFS_GMAC_BASE+SAM_GMAC_BCFT_OFFSET)
#define SAM_GMAC_MFT               (MPFS_GMAC_BASE+SAM_GMAC_MFT_OFFSET)
#define SAM_GMAC_PFT               (MPFS_GMAC_BASE+SAM_GMAC_PFT_OFFSET)
#define SAM_GMAC_BFT64             (MPFS_GMAC_BASE+SAM_GMAC_BFT64_OFFSET)
#define SAM_GMAC_TBFT127           (MPFS_GMAC_BASE+SAM_GMAC_TBFT127_OFFSET)
#define SAM_GMAC_TBFT255           (MPFS_GMAC_BASE+SAM_GMAC_TBFT255_OFFSET)
#define SAM_GMAC_TBFT511           (MPFS_GMAC_BASE+SAM_GMAC_TBFT511_OFFSET)
#define SAM_GMAC_TBFT1023          (MPFS_GMAC_BASE+SAM_GMAC_TBFT1023_OFFSET)
#define SAM_GMAC_TBFT1518          (MPFS_GMAC_BASE+SAM_GMAC_TBFT1518_OFFSET)
#define SAM_GMAC_GTBFT1518         (MPFS_GMAC_BASE+SAM_GMAC_GTBFT1518_OFFSET)
#define SAM_GMAC_TUR               (MPFS_GMAC_BASE+SAM_GMAC_TUR_OFFSET)
#define SAM_GMAC_SCF               (MPFS_GMAC_BASE+SAM_GMAC_SCF_OFFSET)
#define SAM_GMAC_MCF               (MPFS_GMAC_BASE+SAM_GMAC_MCF_OFFSET)
#define SAM_GMAC_EC                (MPFS_GMAC_BASE+SAM_GMAC_EC_OFFSET)
#define SAM_GMAC_LC                (MPFS_GMAC_BASE+SAM_GMAC_LC_OFFSET)
#define SAM_GMAC_DTF               (MPFS_GMAC_BASE+SAM_GMAC_DTF_OFFSET)
#define SAM_GMAC_CSE               (MPFS_GMAC_BASE+SAM_GMAC_CSE_OFFSET)
#define SAM_GMAC_ORLO              (MPFS_GMAC_BASE+SAM_GMAC_ORLO_OFFSET)
#define SAM_GMAC_ORHI              (MPFS_GMAC_BASE+SAM_GMAC_ORHI_OFFSET)
#define SAM_GMAC_FR                (MPFS_GMAC_BASE+SAM_GMAC_FR_OFFSET)
#define SAM_GMAC_BCFR              (MPFS_GMAC_BASE+SAM_GMAC_BCFR_OFFSET)
#define SAM_GMAC_MFR               (MPFS_GMAC_BASE+SAM_GMAC_MFR_OFFSET)
#define SAM_GMAC_PFR               (MPFS_GMAC_BASE+SAM_GMAC_PFR_OFFSET)
#define SAM_GMAC_BFR64             (MPFS_GMAC_BASE+SAM_GMAC_BFR64_OFFSET)
#define SAM_GMAC_TBFR127           (MPFS_GMAC_BASE+SAM_GMAC_TBFR127_OFFSET)
#define SAM_GMAC_TBFR255           (MPFS_GMAC_BASE+SAM_GMAC_TBFR255_OFFSET)
#define SAM_GMAC_TBFR511           (MPFS_GMAC_BASE+SAM_GMAC_TBFR511_OFFSET)
#define SAM_GMAC_TBFR1023          (MPFS_GMAC_BASE+SAM_GMAC_TBFR1023_OFFSET)
#define SAM_GMAC_TBFR1518          (MPFS_GMAC_BASE+SAM_GMAC_TBFR1518_OFFSET)
#define SAM_GMAC_TMXBFR            (MPFS_GMAC_BASE+SAM_GMAC_TMXBFR_OFFSET)
#define SAM_GMAC_UFR               (MPFS_GMAC_BASE+SAM_GMAC_UFR_OFFSET)
#define SAM_GMAC_OFR               (MPFS_GMAC_BASE+SAM_GMAC_OFR_OFFSET)
#define SAM_GMAC_JR                (MPFS_GMAC_BASE+SAM_GMAC_JR_OFFSET)
#define SAM_GMAC_FCSE              (MPFS_GMAC_BASE+SAM_GMAC_FCSE_OFFSET)
#define SAM_GMAC_LFFE              (MPFS_GMAC_BASE+SAM_GMAC_LFFE_OFFSET)
#define SAM_GMAC_RSE               (MPFS_GMAC_BASE+SAM_GMAC_RSE_OFFSET)
#define SAM_GMAC_AE                (MPFS_GMAC_BASE+SAM_GMAC_AE_OFFSET)
#define SAM_GMAC_RRE               (MPFS_GMAC_BASE+SAM_GMAC_RRE_OFFSET)
#define SAM_GMAC_ROE               (MPFS_GMAC_BASE+SAM_GMAC_ROE_OFFSET)
#define SAM_GMAC_IHCE              (MPFS_GMAC_BASE+SAM_GMAC_IHCE_OFFSET)
#define SAM_GMAC_TCE               (MPFS_GMAC_BASE+SAM_GMAC_TCE_OFFSET)
#define SAM_GMAC_UCE               (MPFS_GMAC_BASE+SAM_GMAC_UCE_OFFSET)
#define SAM_GMAC_TSSS              (MPFS_GMAC_BASE+SAM_GMAC_TSSS_OFFSET)
#define SAM_GMAC_TSSN              (MPFS_GMAC_BASE+SAM_GMAC_TSSN_OFFSET)
#define SAM_GMAC_TS                (MPFS_GMAC_BASE+SAM_GMAC_TS_OFFSET)
#define SAM_GMAC_TN                (MPFS_GMAC_BASE+SAM_GMAC_TN_OFFSET)
#define SAM_GMAC_TA                (MPFS_GMAC_BASE+SAM_GMAC_TA_OFFSET)
#define SAM_GMAC_TI                (MPFS_GMAC_BASE+SAM_GMAC_TI_OFFSET)
#define SAM_GMAC_EFTS              (MPFS_GMAC_BASE+SAM_GMAC_EFTS_OFFSET)
#define SAM_GMAC_EFTN              (MPFS_GMAC_BASE+SAM_GMAC_EFTN_OFFSET)
#define SAM_GMAC_EFRS              (MPFS_GMAC_BASE+SAM_GMAC_EFRS_OFFSET)
#define SAM_GMAC_EFRN              (MPFS_GMAC_BASE+SAM_GMAC_EFRN_OFFSET)
#define SAM_GMAC_PEFTS             (MPFS_GMAC_BASE+SAM_GMAC_PEFTS_OFFSET)
#define SAM_GMAC_PEFTN             (MPFS_GMAC_BASE+SAM_GMAC_PEFTN_OFFSET)
#define SAM_GMAC_PEFRS             (MPFS_GMAC_BASE+SAM_GMAC_PEFRS_OFFSET)
#define SAM_GMAC_PEFRN             (MPFS_GMAC_BASE+SAM_GMAC_PEFRN_OFFSET)
#define SAM_GMAC_ISRPQ(n)          (MPFS_GMAC_BASE+SAM_GMAC_ISRPQ_OFFSET(n))
#define SAM_GMAC_ISRPQ0            (MPFS_GMAC_BASE+SAM_GMAC_ISRPQ0_OFFSET)
#define SAM_GMAC_ISRPQ1            (MPFS_GMAC_BASE+SAM_GMAC_ISRPQ1_OFFSET)
#define SAM_GMAC_ISRPQ2            (MPFS_GMAC_BASE+SAM_GMAC_ISRPQ2_OFFSET)
#define SAM_GMAC_ISRPQ3            (MPFS_GMAC_BASE+SAM_GMAC_ISRPQ3_OFFSET)
#define SAM_GMAC_ISRPQ4            (MPFS_GMAC_BASE+SAM_GMAC_ISRPQ4_OFFSET)
#define SAM_GMAC_ISRPQ5            (MPFS_GMAC_BASE+SAM_GMAC_ISRPQ5_OFFSET)
#define SAM_GMAC_ISRPQ6            (MPFS_GMAC_BASE+SAM_GMAC_ISRPQ6_OFFSET)
#define SAM_GMAC_TBQBAPQ(n)        (MPFS_GMAC_BASE+SAM_GMAC_TBQBAPQ_OFFSET(n))
#define SAM_GMAC_TBQBAPQ0          (MPFS_GMAC_BASE+SAM_GMAC_TBQBAPQ0_OFFSET)
#define SAM_GMAC_TBQBAPQ1          (MPFS_GMAC_BASE+SAM_GMAC_TBQBAPQ1_OFFSET)
#define SAM_GMAC_TBQBAPQ2          (MPFS_GMAC_BASE+SAM_GMAC_TBQBAPQ2_OFFSET)
#define SAM_GMAC_TBQBAPQ3          (MPFS_GMAC_BASE+SAM_GMAC_TBQBAPQ3_OFFSET)
#define SAM_GMAC_TBQBAPQ4          (MPFS_GMAC_BASE+SAM_GMAC_TBQBAPQ4_OFFSET)
#define SAM_GMAC_TBQBAPQ5          (MPFS_GMAC_BASE+SAM_GMAC_TBQBAPQ5_OFFSET)
#define SAM_GMAC_TBQBAPQ6          (MPFS_GMAC_BASE+SAM_GMAC_TBQBAPQ6_OFFSET)
#define SAM_GMAC_RBQBAPQ(n)        (MPFS_GMAC_BASE+SAM_GMAC_RBQBAPQ_OFFSET(n))
#define SAM_GMAC_RBQBAPQ0          (MPFS_GMAC_BASE+SAM_GMAC_RBQBAPQ0_OFFSET)
#define SAM_GMAC_RBQBAPQ1          (MPFS_GMAC_BASE+SAM_GMAC_RBQBAPQ1_OFFSET)
#define SAM_GMAC_RBQBAPQ2          (MPFS_GMAC_BASE+SAM_GMAC_RBQBAPQ2_OFFSET)
#define SAM_GMAC_RBQBAPQ3          (MPFS_GMAC_BASE+SAM_GMAC_RBQBAPQ3_OFFSET)
#define SAM_GMAC_RBQBAPQ4          (MPFS_GMAC_BASE+SAM_GMAC_RBQBAPQ4_OFFSET)
#define SAM_GMAC_RBQBAPQ5          (MPFS_GMAC_BASE+SAM_GMAC_RBQBAPQ5_OFFSET)
#define SAM_GMAC_RBQBAPQ6          (MPFS_GMAC_BASE+SAM_GMAC_RBQBAPQ6_OFFSET)
#define SAM_GMAC_RBSRPQ(n)         (MPFS_GMAC_BASE+SAM_GMAC_RBSRPQ_OFFSET(n))
#define SAM_GMAC_RBSRPQ0           (MPFS_GMAC_BASE+SAM_GMAC_RBSRPQ0_OFFSET)
#define SAM_GMAC_RBSRPQ1           (MPFS_GMAC_BASE+SAM_GMAC_RBSRPQ1_OFFSET)
#define SAM_GMAC_RBSRPQ2           (MPFS_GMAC_BASE+SAM_GMAC_RBSRPQ2_OFFSET)
#define SAM_GMAC_RBSRPQ3           (MPFS_GMAC_BASE+SAM_GMAC_RBSRPQ3_OFFSET)
#define SAM_GMAC_RBSRPQ4           (MPFS_GMAC_BASE+SAM_GMAC_RBSRPQ4_OFFSET)
#define SAM_GMAC_RBSRPQ5           (MPFS_GMAC_BASE+SAM_GMAC_RBSRPQ5_OFFSET)
#define SAM_GMAC_RBSRPQ6           (MPFS_GMAC_BASE+SAM_GMAC_RBSRPQ6_OFFSET)
#define SAM_GMAC_ST1RPQ(n)         (MPFS_GMAC_BASE+SAM_GMAC_ST1RPQ_OFFSET(n))
#define SAM_GMAC_ST1RPQ0           (MPFS_GMAC_BASE+SAM_GMAC_ST1RPQ0_OFFSET)
#define SAM_GMAC_ST1RPQ1           (MPFS_GMAC_BASE+SAM_GMAC_ST1RPQ1_OFFSET)
#define SAM_GMAC_ST1RPQ2           (MPFS_GMAC_BASE+SAM_GMAC_ST1RPQ2_OFFSET)
#define SAM_GMAC_ST1RPQ3           (MPFS_GMAC_BASE+SAM_GMAC_ST1RPQ3_OFFSET)
#define SAM_GMAC_ST1RPQ4           (MPFS_GMAC_BASE+SAM_GMAC_ST1RPQ4_OFFSET)
#define SAM_GMAC_ST1RPQ5           (MPFS_GMAC_BASE+SAM_GMAC_ST1RPQ5_OFFSET)
#define SAM_GMAC_ST1RPQ6           (MPFS_GMAC_BASE+SAM_GMAC_ST1RPQ6_OFFSET)
#define SAM_GMAC_ST1RPQ7           (MPFS_GMAC_BASE+SAM_GMAC_ST1RPQ7_OFFSET)
#define SAM_GMAC_ST1RPQ8           (MPFS_GMAC_BASE+SAM_GMAC_ST1RPQ8_OFFSET)
#define SAM_GMAC_ST1RPQ9           (MPFS_GMAC_BASE+SAM_GMAC_ST1RPQ9_OFFSET)
#define SAM_GMAC_ST1RPQ10          (MPFS_GMAC_BASE+SAM_GMAC_ST1RPQ10_OFFSET)
#define SAM_GMAC_ST1RPQ11          (MPFS_GMAC_BASE+SAM_GMAC_ST1RPQ11_OFFSET)
#define SAM_GMAC_ST1RPQ12          (MPFS_GMAC_BASE+SAM_GMAC_ST1RPQ12_OFFSET)
#define SAM_GMAC_ST1RPQ13          (MPFS_GMAC_BASE+SAM_GMAC_ST1RPQ13_OFFSET)
#define SAM_GMAC_ST1RPQ14          (MPFS_GMAC_BASE+SAM_GMAC_ST1RPQ14_OFFSET)
#define SAM_GMAC_ST1RPQ15          (MPFS_GMAC_BASE+SAM_GMAC_ST1RPQ15_OFFSET)
#define SAM_GMAC_ST2RPQ(n)         (MPFS_GMAC_BASE+SAM_GMAC_ST2RPQ_OFFSET(n))
#define SAM_GMAC_ST2RPQ0           (MPFS_GMAC_BASE+SAM_GMAC_ST2RPQ0_OFFSET)
#define SAM_GMAC_ST2RPQ1           (MPFS_GMAC_BASE+SAM_GMAC_ST2RPQ1_OFFSET)
#define SAM_GMAC_ST2RPQ2           (MPFS_GMAC_BASE+SAM_GMAC_ST2RPQ2_OFFSET)
#define SAM_GMAC_ST2RPQ3           (MPFS_GMAC_BASE+SAM_GMAC_ST2RPQ3_OFFSET)
#define SAM_GMAC_ST2RPQ4           (MPFS_GMAC_BASE+SAM_GMAC_ST2RPQ4_OFFSET)
#define SAM_GMAC_ST2RPQ5           (MPFS_GMAC_BASE+SAM_GMAC_ST2RPQ5_OFFSET)
#define SAM_GMAC_ST2RPQ6           (MPFS_GMAC_BASE+SAM_GMAC_ST2RPQ6_OFFSET)
#define SAM_GMAC_ST2RPQ7           (MPFS_GMAC_BASE+SAM_GMAC_ST2RPQ7_OFFSET)
#define SAM_GMAC_ST2RPQ8           (MPFS_GMAC_BASE+SAM_GMAC_ST2RPQ8_OFFSET)
#define SAM_GMAC_ST2RPQ9           (MPFS_GMAC_BASE+SAM_GMAC_ST2RPQ9_OFFSET)
#define SAM_GMAC_ST2RPQ10          (MPFS_GMAC_BASE+SAM_GMAC_ST2RPQ10_OFFSET)
#define SAM_GMAC_ST2RPQ11          (MPFS_GMAC_BASE+SAM_GMAC_ST2RPQ11_OFFSET)
#define SAM_GMAC_ST2RPQ12          (MPFS_GMAC_BASE+SAM_GMAC_ST2RPQ12_OFFSET)
#define SAM_GMAC_ST2RPQ13          (MPFS_GMAC_BASE+SAM_GMAC_ST2RPQ13_OFFSET)
#define SAM_GMAC_ST2RPQ14          (MPFS_GMAC_BASE+SAM_GMAC_ST2RPQ14_OFFSET)
#define SAM_GMAC_ST2RPQ15          (MPFS_GMAC_BASE+SAM_GMAC_ST2RPQ15_OFFSET)
#define SAM_GMAC_IERPQ(n)          (MPFS_GMAC_BASE+SAM_GMAC_IERPQ_OFFSET(n))
#define SAM_GMAC_IERPQ0            (MPFS_GMAC_BASE+SAM_GMAC_IERPQ0_OFFSET)
#define SAM_GMAC_IERPQ1            (MPFS_GMAC_BASE+SAM_GMAC_IERPQ1_OFFSET)
#define SAM_GMAC_IERPQ2            (MPFS_GMAC_BASE+SAM_GMAC_IERPQ2_OFFSET)
#define SAM_GMAC_IERPQ3            (MPFS_GMAC_BASE+SAM_GMAC_IERPQ3_OFFSET)
#define SAM_GMAC_IERPQ4            (MPFS_GMAC_BASE+SAM_GMAC_IERPQ4_OFFSET)
#define SAM_GMAC_IERPQ5            (MPFS_GMAC_BASE+SAM_GMAC_IERPQ5_OFFSET)
#define SAM_GMAC_IERPQ6            (MPFS_GMAC_BASE+SAM_GMAC_IERPQ6_OFFSET)
#define SAM_GMAC_IDRPQ(n)          (MPFS_GMAC_BASE+SAM_GMAC_IDRPQ_OFFSET(n))
#define SAM_GMAC_IDRPQ0            (MPFS_GMAC_BASE+SAM_GMAC_IDRPQ0_OFFSET)
#define SAM_GMAC_IDRPQ1            (MPFS_GMAC_BASE+SAM_GMAC_IDRPQ1_OFFSET)
#define SAM_GMAC_IDRPQ2            (MPFS_GMAC_BASE+SAM_GMAC_IDRPQ2_OFFSET)
#define SAM_GMAC_IDRPQ3            (MPFS_GMAC_BASE+SAM_GMAC_IDRPQ3_OFFSET)
#define SAM_GMAC_IDRPQ4            (MPFS_GMAC_BASE+SAM_GMAC_IDRPQ4_OFFSET)
#define SAM_GMAC_IDRPQ5            (MPFS_GMAC_BASE+SAM_GMAC_IDRPQ5_OFFSET)
#define SAM_GMAC_IDRPQ6            (MPFS_GMAC_BASE+SAM_GMAC_IDRPQ6_OFFSET)
#define SAM_GMAC_IMRPQ(n)          (MPFS_GMAC_BASE+SAM_GMAC_IMRPQ_OFFSET(n))
#define SAM_GMAC_IMRPQ0            (MPFS_GMAC_BASE+SAM_GMAC_IMRPQ0_OFFSET)
#define SAM_GMAC_IMRPQ1            (MPFS_GMAC_BASE+SAM_GMAC_IMRPQ1_OFFSET)
#define SAM_GMAC_IMRPQ2            (MPFS_GMAC_BASE+SAM_GMAC_IMRPQ2_OFFSET)
#define SAM_GMAC_IMRPQ3            (MPFS_GMAC_BASE+SAM_GMAC_IMRPQ3_OFFSET)
#define SAM_GMAC_IMRPQ4            (MPFS_GMAC_BASE+SAM_GMAC_IMRPQ4_OFFSET)
#define SAM_GMAC_IMRPQ5            (MPFS_GMAC_BASE+SAM_GMAC_IMRPQ5_OFFSET)
#define SAM_GMAC_IMRPQ6            (MPFS_GMAC_BASE+SAM_GMAC_IMRPQ6_OFFSET)
...
#define GMAC_NCFGR_PCSSEL         (1 << 11) /* Bit 10: PCS ?? for SGMII? */
...
#  define GMAC_NCFGR_DBW_128      (2 << GMAC_NCFGR_DBW_SHIFT) /* 128-bit data bus width */
...
#define GMAC_NCFGR_SGMIIEN        (1 << 27) /* Bit 27: Enable SGMII mode */
...
struct gmac_rxdesc_s
{
  ...
  uint32_t addr_hi;  /* Buffer address */
  uint32_t unused;
#endif
};
