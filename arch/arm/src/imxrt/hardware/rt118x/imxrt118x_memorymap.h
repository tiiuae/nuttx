...
#define IMXRT_M7_SYSTEM_BASE            (0x00000000ul)  /* M7 lower system map     2 GB */
#define IMXRT_M7_SYSTEM_SIZE            (2ul * 1024 * 1024 * 1024)
#define IMXRT_ITCM_BASE                 (0x00000000ul)  /* M7 ITCM              256 KB */
#define IMXRT_M7_ROM_BASE               (0x00100000ul)  /* M7 ROM               256 KB */
#define IMXRT_M7_ROM_SIZE               (256 * 1024)
...
#define IMXRT_SEMC0_SIZE                (512 * 1024 * 1024)
