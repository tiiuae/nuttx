/****************************************************************************
 * arch/arm/src/stm32n6/hardware/stm32n6xxx_tim.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32N6_HARDWARE_STM32N6XXX_TIM_H
#define __ARCH_ARM_SRC_STM32N6_HARDWARE_STM32N6XXX_TIM_H
...
/* The STM32N6 family uses STM32 TIMER IP version 2 */

#define HAVE_IP_TIMERS_V2 1

/* Register Offsets *********************************************************/

/* Basic Timers - TIM6, TIM7, and TIM18 */
...
/* General Purpose Timers - TIM2-5 and TIM15-17 */
...
#define STM32_TIM18_CR1         (STM32_TIM18_BASE+STM32_BTIM_CR1_OFFSET)
#define STM32_TIM18_CR2         (STM32_TIM18_BASE+STM32_BTIM_CR2_OFFSET)
#define STM32_TIM18_DIER        (STM32_TIM18_BASE+STM32_BTIM_DIER_OFFSET)
#define STM32_TIM18_SR          (STM32_TIM18_BASE+STM32_BTIM_SR_OFFSET)
#define STM32_TIM18_EGR         (STM32_TIM18_BASE+STM32_BTIM_EGR_OFFSET)
#define STM32_TIM18_CNT         (STM32_TIM18_BASE+STM32_BTIM_CNT_OFFSET)
#define STM32_TIM18_PSC         (STM32_TIM18_BASE+STM32_BTIM_PSC_OFFSET)
#define STM32_TIM18_ARR         (STM32_TIM18_BASE+STM32_BTIM_ARR_OFFSET)
...
/* General-purpose timers: TIM9 and TIM12 have two channels and slave-mode
 * control; TIM10, TIM11, TIM13, and TIM14 have one channel.
 */

#define STM32_TIM9_CR1          (STM32_TIM9_BASE+STM32_GTIM_CR1_OFFSET)
#define STM32_TIM9_CR2          (STM32_TIM9_BASE+STM32_GTIM_CR2_OFFSET)
#define STM32_TIM9_SMCR         (STM32_TIM9_BASE+STM32_GTIM_SMCR_OFFSET)
...
#define STM32_TIM9_TISEL        (STM32_TIM9_BASE+STM32_GTIM_TISEL_OFFSET)
...
#define STM32_TIM10_TISEL       (STM32_TIM10_BASE+STM32_GTIM_TISEL_OFFSET)
...
#define STM32_TIM11_TISEL       (STM32_TIM11_BASE+STM32_GTIM_TISEL_OFFSET)
...
/* General-purpose timers: TIM15 has two channels and slave-mode control;
 * TIM16 and TIM17 have one channel.
 */
...
#define ATIM_CR2_ADSYNC           (1 << 28) /* Bit 28: ADC synchronization */
...
#define ATIM_SMCR_TS              ATIM_SMCR_OCCS /* Compatibility alias */
...
#define GTIM_CR2_ADSYNC           (1 << 28) /* Bit 28: ADC synchronization */
...
#define GTIM_SMCR_TS43_SHIFT      (20)      /* Bits 21-20: Trigger selection bits 4:3 */
#define GTIM_SMCR_TS43_MASK       (3 << GTIM_SMCR_TS43_SHIFT)
...
#endif /* __ARCH_ARM_SRC_STM32N6_HARDWARE_STM32N6XXX_TIM_H */
