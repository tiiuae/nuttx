/****************************************************************************
 * arch/arm/src/mcx-nxxx/nxxx_gpio.h
 *
...
#ifndef __ARCH_ARM_SRC_MCX_NXXX_NXXX_GPIO_H
...
/* GPIO pinset is a 32-bit word used to configure the GPIO settings. The
 * lowest 16 bits configure the GPIO pin, while the highest 16 bits configure
 * the PORT Control register for the pin. The encoding is as follows...
 *
 *               3322 2222 2222 1111 1111 1100 0000 0000
 *               1098 7654 3210 9876 5432 1098 7654 3210
 *   ENCODING    PPPP PPPP PPPP PPPP MMVX BEEG GGGP PPPP
 *   GPIO INPUT  PPPP PPPP PPPP PPPP 00.. BEEG GGGP PPPP
 *   INT INPUT   PPPP PPPP PPPP PPPP 11.. BEEG GGGP PPPP
 *   GPIO OUTPUT PPPP PPPP PPPP PPPP 01V. ...G GGGP PPPP
 */

/* Port Configuration (refer to nxxx_port.h):
 *
 *               3322 2222 2222 1111 1111 1100 0000 0000
 *               1098 7654 3210 9876 5432 1098 7654 3210
 *   ENCODING    PPPP PPPP PPPP PPPP .... .... .... ....
 */

#define GPIO_PORT_CFG_SHIFT    (15)
...
#define NXXX_GPIO_BASE(n)      g_gpio_base[n]  /* Use GPIO1..GPIOn macros as indices */

#define NXXX_GPIO_VERID(n)     (NXXX_GPIO_BASE(n) + NXXX_GPIO_VERID_OFFSET)
#define NXXX_GPIO_PARAM(n)     (NXXX_GPIO_BASE(n) + NXXX_GPIO_PARAM_OFFSET)
#define NXXX_GPIO_LOCK(n)      (NXXX_GPIO_BASE(n) + NXXX_GPIO_LOCK_OFFSET)
#define NXXX_GPIO_PCNS(n)      (NXXX_GPIO_BASE(n) + NXXX_GPIO_PCNS_OFFSET)
#define NXXX_GPIO_ICNS(n)      (NXXX_GPIO_BASE(n) + NXXX_GPIO_ICNS_OFFSET)
#define NXXX_GPIO_PCNP(n)      (NXXX_GPIO_BASE(n) + NXXX_GPIO_PCNP_OFFSET)
#define NXXX_GPIO_ICNP(n)      (NXXX_GPIO_BASE(n) + NXXX_GPIO_ICNP_OFFSET)
#define NXXX_GPIO_PDOR(n)      (NXXX_GPIO_BASE(n) + NXXX_GPIO_PDOR_OFFSET)
#define NXXX_GPIO_PSOR(n)      (NXXX_GPIO_BASE(n) + NXXX_GPIO_PSOR_OFFSET)
#define NXXX_GPIO_PCOR(n)      (NXXX_GPIO_BASE(n) + NXXX_GPIO_PCOR_OFFSET)
#define NXXX_GPIO_PTOR(n)      (NXXX_GPIO_BASE(n) + NXXX_GPIO_PTOR_OFFSET)
#define NXXX_GPIO_PDIR(n)      (NXXX_GPIO_BASE(n) + NXXX_GPIO_PDIR_OFFSET)
#define NXXX_GPIO_PDDR(n)      (NXXX_GPIO_BASE(n) + NXXX_GPIO_PDDR_OFFSET)
#define NXXX_GPIO_PIDR(n)      (NXXX_GPIO_BASE(n) + NXXX_GPIO_PIDR_OFFSET)
#define NXXX_GPIO_GICLR(n)     (NXXX_GPIO_BASE(n) + NXXX_GPIO_GICLR_OFFSET)
#define NXXX_GPIO_GICHR(n)     (NXXX_GPIO_BASE(n) + NXXX_GPIO_GICHR_OFFSET)

/* Interrupt status flags, these have two channels. Channel is selected by
 * setting / clearing ICRN.IRQS bit.
 */

#define NXXX_GPIO_ISFR0(n)     (NXXX_GPIO_BASE(n) + NXXX_GPIO_ISFR0_OFFSET)
#define NXXX_GPIO_ISFR1(n)     (NXXX_GPIO_BASE(n) + NXXX_GPIO_ISFR1_OFFSET)

/* GPIO PIN[0...31] and ICR[0...31] */

#define NXXX_GPIO_P0DR(n)      (NXXX_GPIO_BASE(n) + NXXX_GPIO_P0DR_OFFSET)
#define NXXX_GPIO_PNDR(n, p)   (NXXX_GPIO_P0DR(n) + ((p) * 0x4))
#define NXXX_GPIO_ICR0(n)      (NXXX_GPIO_BASE(n) + NXXX_GPIO_ICR0_OFFSET)
#define NXXX_GPIO_ICRN(n, p)   (NXXX_GPIO_ICR0(n) + ((p) * 0x4))
...
#else
#  define nxxx_gpioirq_initialize()
#endif
...
#else
#define nxxx_gpioirq_attach(pinset, isr, arg) 0
#endif
...
#else
#  define nxxx_gpioirq_configure(pinset) 0
#endif
...
#else
#  define nxxx_gpioirq_enable(pinset) 0
#endif
...
#else
#  define nxxx_gpioirq_disable(pinset) 0
#endif
...
#endif
#endif /* __ARCH_ARM_SRC_MCX_NXXX_NXXX_GPIO_H */
