...
void nxxx_lowsetup(void)
{
  ...
  nxxx_iomux_configure(MUX_LPUART0_RX);
  nxxx_iomux_configure(MUX_LPUART0_TX);
#ifdef CONFIG_LPUART1_OFLOWCONTROL
  nxxx_iomux_configure(MUX_LPUART0_CTS);
#endif
  ...
  nxxx_iomux_configure(MUX_LPUART0_RTS);
#endif
#endif
  ...
  nxxx_iomux_configure(MUX_LPUART1_RX);
  nxxx_iomux_configure(MUX_LPUART1_TX);
#ifdef CONFIG_LPUART1_OFLOWCONTROL
  nxxx_iomux_configure(MUX_LPUART1_CTS);
#endif
#if ((defined(CONFIG_SERIAL_RS485CONTROL) && defined(CONFIG_LPUART1_RS485RTSCONTROL)) || \
     (defined(CONFIG_SERIAL_IFLOWCONTROL) && defined(CONFIG_LPUART1_IFLOWCONTROL)))
  nxxx_iomux_configure(MUX_LPUART1_RTS);
#endif
#endif
  ...
  nxxx_iomux_configure(MUX_LPUART2_RX);
  nxxx_iomux_configure(MUX_LPUART2_TX);
#ifdef CONFIG_LPUART2_OFLOWCONTROL
  nxxx_iomux_configure(MUX_LPUART2_CTS);
#endif
  ...
  nxxx_iomux_configure(MUX_LPUART2_RTS);
#endif
#endif
  ...
  nxxx_iomux_configure(MUX_LPUART3_RX);
  nxxx_iomux_configure(MUX_LPUART3_TX);
#ifdef CONFIG_LPUART3_OFLOWCONTROL
  nxxx_iomux_configure(MUX_LPUART3_CTS);
#endif
  ...
  nxxx_iomux_configure(MUX_LPUART3_RTS);
#endif
#endif
  ...
  nxxx_iomux_configure(MUX_LPUART4_RX);
  nxxx_iomux_configure(MUX_LPUART4_TX);
#ifdef CONFIG_LPUART4_OFLOWCONTROL
  nxxx_iomux_configure(MUX_LPUART4_CTS);
#endif
  ...
  nxxx_iomux_configure(MUX_LPUART4_RTS);
#endif
#endif
  ...
  nxxx_iomux_configure(MUX_LPUART5_RX);
  nxxx_iomux_configure(MUX_LPUART5_TX);
#ifdef CONFIG_LPUART5_OFLOWCONTROL
  nxxx_iomux_configure(MUX_LPUART5_CTS);
#endif
  ...
  nxxx_iomux_configure(MUX_LPUART5_RTS);
#endif
#endif
  ...
  nxxx_iomux_configure(MUX_LPUART6_RX);
  nxxx_iomux_configure(MUX_LPUART6_TX);
#ifdef CONFIG_LPUART6_OFLOWCONTROL
  nxxx_iomux_configure(MUX_LPUART6_CTS);
#endif
  ...
  nxxx_iomux_configure(MUX_LPUART6_RTS);
#endif
#endif
  ...
  nxxx_iomux_configure(MUX_LPUART7_RX);
  nxxx_iomux_configure(MUX_LPUART7_TX);
#ifdef CONFIG_LPUART7_OFLOWCONTROL
  nxxx_iomux_configure(MUX_LPUART7_CTS);
#endif
  ...
  nxxx_iomux_configure(MUX_LPUART7_RTS);
#endif
#endif
                          ...
                          const struct uart_config_s *config)
{
  ...
  struct clock_gate_reg clock_gate;
  uint16_t sbr;
  uint16_t temp_sbr;
  uint32_t osr;
  uint32_t temp_osr;
  ...
  nxxx_set_periphclock(clock_regs, FRO12M_TO_FLEXCOMM0, 1);
